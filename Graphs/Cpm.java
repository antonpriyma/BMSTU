    ...
    public static  void solve() {
        ...
        for (;;) {
            ...
            for (int j = 0; j < m; ++j) {
                ...
                if (d.get(vert.get(j).a) < INF && !checkEd.contains(vert.get(j).a)) {
                    if (d.get(vert.get(j).b) > d.get(vert.get(j).a) + vert.get(j).cost-counter.get(val)) {
                        d.put(vert.get(j).b, d.get(vert.get(j).a) + vert.get(j).cost-counter.get(val));
                        ...
                        any = true;
                    } else if (d.get(vert.get(j).b) == d.get(vert.get(j).a) + vert.get(j).cost-counter.get(val)) {
                        if (p.containsKey(vert.get(j).b)) {
                            ;
                            p.get(vert.get(j).b).add(vert.get(j).a);
                        } else {
        ...
        for (int i = 0; i < d.size(); i++) {
            if (m==0){
                ...
                if (d.get(keys[i]) - counter.get(val) < min && color.get(keys[i]) != -1) {
                    min = d.get(keys[i]) - counter.get(val);
                    t.clear();
                    t.add(i);
                } else if (d.get(keys[i]) - counter.get(val)== min && color.get(keys[i]) != -1) {
                    t.add(i);
                }
            }
        }
